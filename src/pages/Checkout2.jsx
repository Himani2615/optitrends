...
export const Checkout2 = () => {
  return (
    <div>
      ...
      <img src="src/assets/progress2.png" className='self-center m-10' style={{width:"min-content"}}/>
    ...
    <div className="w-full max-w-4xl mx-auto p-8">
        <div className=" p-8 rounded-lg ">
          ...
          <Link to="/review"><button className="text-[#2C3E50] border border-[#2C3E50] hidden sm:block px-auto py-auto rounded-lg  w-40 h-10">← Back</button></Link>
        </div>
        <div className="mt-8 items-end float-right w-full lg:w-40 md:w-40">
          <Link to="/payment"><button className="bg-[#2C3E50] text-white px-auto py-auto rounded-lg w-full lg:w-40 md:w-40  h-10 ">Next</button></Link>
        </div>
