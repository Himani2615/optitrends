...
export const Checkout3 = () => {
  return (
    <div>
      ...
      <img src="src/assets/progress3.png" className='self-center m-10' style={{width:"min-content"}}/>
...
<div className="mt-8 items-end float-left ">
        ...
        <div className="mt-8 items-end float-right w-full lg:w-40">
          <Link to="/payment"><button className="bg-[#2C3E50] text-white px-auto py-auto rounded-lg  w-full lg:w-40 md:w-40  h-10  px-1">Confirm Payment</button></Link>
        </div>
</div>
